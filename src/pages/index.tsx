  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Management Application: Streamlining Human Resources Processes for a More Efficient, Productive, and Employee-Centric Workplace Experience."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Management Application: Streamlining Human Resources Processes for a More Efficient, Productive, and Employee-Centric Workplace Experience.`}
            </Text>
            <Box
